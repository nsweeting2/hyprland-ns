...
run_command "pacman -S --noconfirm uwsm && systemctl enable uwsm.service" "Install and enable UWSM (Recommended)" "yes"
...
run_command "pacman -S --noconfirm hyprpolkitagent" "Install Hypr Polkit Agent for authentication dialogs" "yes" "no"

# run_command "pacman -S --noconfirm dunst" "Install Dunst notification daemon" "yes" "no"
run_command "pacman -S --noconfirm mako" "Install Mako notification daemon" "yes" "no"
